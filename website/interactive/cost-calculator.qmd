...
.cost-sheet .k { font-weight: 600; color: var(--text-muted); }
.cost-sheet .v { font-variant-numeric: tabular-nums; }
.cost-sheet .tot { border-top: 1px solid var(--border); padding-top: 0.4rem; }
.cost-table { border-collapse: collapse; width: 100%; margin-top: 0.75rem; }
.cost-table th, .cost-table td { border: 1px solid var(--border); padding: 0.35rem 0.6rem; text-align: right; }
.cost-table th { background: var(--surface-3); }
