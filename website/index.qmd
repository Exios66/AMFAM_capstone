...
subtitle: "A prompt-engineering lab over the RVL-CDIP benchmark — 16-class document intelligence via OpenRouter vision models and Braintrust evals"
author:
  - name: "Jack J. Burleson"
    url: "https://github.com/Exios66"
    email: "jjburleson@wisc.edu"
    affiliations:
      - ref: uw
  - name: "Grant Mooslin"
    url: "https://github.com/gmooslin"
    affiliations:
      - ref: uw
  - name: "Siddharth Suresh"
    roles: "Project Advisor"
    affiliations:
      - ref: uw
affiliations:
  - id: uw
...
date: "2026-08-05"
keywords: "RVL-CDIP, document classification, prompt engineering, OpenRouter, Braintrust, vision language models, exact-match evaluation, Monte Carlo, ensemble voting, cost analysis"
format:
  html:
...
<a class="github-btn" href="https://github.com/Exios66/AMFAM_capstone"><i class="bi bi-github"></i> View repository</a>
<a class="github-btn" href="https://github.com/Exios66/AMFAM_capstone/issues/new"><i class="bi bi-bug"></i> Report an issue</a>
</div>
...
::: {.callout-note title="What is this project?"}
This site documents a controlled study: can **prompt engineering alone** — with **no training, no fine-tuning, no model swap** — move a general-purpose vision model's document classification accuracy from ~80% to ~99% on a balanced 160-image slice? The answer is **yes**, and every number here is traceable to committed data.
:::
