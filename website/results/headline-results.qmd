...
::: {.callout-important title="Key Results Summary"}
- **Best slice accuracy**: **99.4%** — prompt `v11.8` on the 160-image balanced set with `qwen3.7-flash`
- **Largest held-out slice**: **1,120 images** spanning three dataset splits, `v11.8` holds **82.6%** (925/1,120)
- **Failure rate**: **0.0%** on the 1,120-image run
- **Near-miss share**: **36.9%** of 195 misses had the correct class as runner-up
:::
...
::: {.callout-warning title="Three Weakest Classes"}
...
::: {.callout-warning title="Slice Bias Warning"}
