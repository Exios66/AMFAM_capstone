...
1. **Recover the near-miss ceiling (+3.9 **pp** simulated on the current prompt
...
2. **Fix the form over-attractor (−2.4 **pp** drag).** `form` is predicted 456×
...
3. **Confidence-gated escalation with a genuinely STRONGER model (+4–6 **pp**
...
Committee voting (**K** = 1→10: 82.1%→85.3%) and the v18 exemplar appendix (−4.2 **pp**
...
1. **Runner-up rescue rule (simulated +3.9 **pp** near-miss ceiling; NOT yet
   ...
   exemplar experiment (−4.2 **pp**) proves more exemplar text is NOT the fix — the
